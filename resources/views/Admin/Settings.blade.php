																				...
																				<h4 class="sherah-default-bg sherah-border__title">Logo & Favicon</h4>
																					<div class="col-12">
																						<div class="sherah__item-form--group mg-top-form-20">
																							...
																							<div class="sherah-input-icon">
																								<img id="preview-logo" class="sherah-input-icon m-5 setting_logo" src="{{'13.jpeg'}}" alt="">
																							</div>
																						</div>
																					</div>
																					<div class="col-12">
																					...
																					<div class="col-12">
																						<div class="sherah__item-form--group mg-top-form-20">
																							...
																							<div class="sherah-input-icon">
																								<img id="preview-logo" class="sherah-input-icon m-5 stiky_logo" src="{{'13.jpeg'}}" alt="">
																							</div>
																						</div>
																					</div>
																					<div class="col-12">
																					...
																					<div class="col-12">
																						<div class="sherah__item-form--group mg-top-form-20">
																							...
																							<div class="sherah-input-icon">
																								<img id="preview-logo" class="sherah-input-icon m-5 favicon" src="{{'13.jpeg'}}" alt="">
																							</div>
																						</div>
																					</div>
																					<div class="col-12">
