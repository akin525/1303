                    ...
                    <a href="{{route('user.dashboard')}}" class="{{ request()->is('user/dashboard') ? 'active' : '' }}">
                        <span>
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M10 4.25C10.4142 4.25 10.75 4.58579 10.75 5V15C10.75 15.4142 10.4142 15.75 10 15.75C9.5858 15.75 9.25 15.4142 9.25 15V5C9.25 4.58579 9.5858 4.25 10 4.25Z" fill="#1a1a1a"/>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M15 6.25C15.4142 6.25 15.75 6.58579 15.75 7V13C15.75 13.4142 15.4142 13.75 15 13.75C14.5858 13.75 14.25 13.4142 14.25 13V7C14.25 6.58579 14.5858 6.25 15 6.25Z" fill="#1a1a1a"/>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M5 6.25C5.41421 6.25 5.75 6.58579 5.75 7V13C5.75 13.4142 5.41421 13.75 5 13.75C4.58579 13.75 4.25 13.4142 4.25 13V7C4.25 6.58579 4.58579 6.25 5 6.25Z" fill="#1a1a1a"/>
                            </svg>
                        </span>
